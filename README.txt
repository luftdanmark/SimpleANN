...
2layer.py is the network and testing functions.
It requires a whole bunch of packages, so I recommend setting up
a virtual environment to install them in.
Python Pip has all of the packages, so simply use that.

Running the program:
Adjust filenames in the main function to reflect dataset filenames

python 2layer.py - to build a new model

python 2layer.py load - to skip building and test with the latest model
